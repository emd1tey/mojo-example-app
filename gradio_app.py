...
with gr.Blocks() as demo:
    gr.Markdown(
        """
# llama2.🔥
## [Mojo](https://docs.modular.com/mojo/)  implementation of  [llama2.c](https://github.com/karpathy/llama2.c)
    """
    )
    with gr.Row():
        with gr.Column():
            ...
            temperature = gr.Slider(
                minimum=0.0, maximum=2.0, step=0.1, value=0.0, label="Temperature"
            )
